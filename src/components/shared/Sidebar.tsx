...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    icon: (
      <path d="M4 6a2 2 0 0 1 2-2h5l2 2h5a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6Zm4 6v4h2v-4H8Zm4-2v6h2v-6h-2Zm4 3v3h2v-3h-2Z" />
    ),
  },
  {
    href: "/molecules",
        ...
        {collapsed ? (
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col">
              <span className="text-sm font-bold tracking-tight text-text">QuDrugForge</span>
              <span className="text-[10px] font-semibold uppercase tracking-widest text-primary/80">Quantum AI Drug Discovery</span>
            </div>
          </div>
        )}
      </div>
