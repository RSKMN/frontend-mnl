  ...
  return (
    <div className="space-y-8 pb-12">
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-5">
        <MetricCard label="QM Evaluated" value="840" helperText="Candidates processed" status="completed" />
        <MetricCard label="QML Reranked" value="150" helperText="High-confidence pool" status="completed" />
        ...
        <MetricCard label="Active Quantum Jobs" value="3" helperText="HPC resources active" status="running" />
      </div>
      ...
      <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
        ...
        <div className="space-y-6">
          ...
          <div className="ui-card-surface p-5 space-y-4">
             ...
             <div className="space-y-3">
                {[
                  { label: "Docking Rank", val: 12, max: 100, color: "bg-muted-text/30" },
                  { label: "ADMET Rank", val: 8, max: 100, color: "bg-muted-text/30" },
                  { label: "Quantum Rank", val: 1, max: 100, color: "bg-accent" },
                  { label: "Final Rank", val: 2, max: 100, color: "bg-emerald-500" }
                ].map(r => (
                  <div key={r.label} className="space-y-1">
                    ...
                    <div className="h-1.5 w-full bg-border/10 rounded-full overflow-hidden">
                      <div className={`h-full ${r.color}`} style={{ width: `${100 - r.val}%` }} />
                    </div>
                  </div>
                ))}
             </div>
